...
$isSeatAvailable = $bookmodel->checkSeat($_SESSION['pickedSeat']['seats'][0], $_SESSION['seans_id']);
if (!$isSeatAvailable) {
    ...
    <div class="checkout">
        ...
        <form class="form" autocomplete="off" novalidate>
            ...
            <fieldset class="fieldset-expiration">
                <label for="card-expiration-month">Дата</label>
                <div class="select">
            ...
            <button id="pay-btn" class="btn"><i class="fa fa-lock"></i>Оплатить</button>
            <div class="total">
                <span>Итого к оплате: <?= $_SESSION['total_price']; ?> ₽</span>
            </div>
        </form>
    </div>
    ...
    ?>
    <div class="error-seats-brone">
        <img src="../resource/images/error.png" alt="">
        <h2>Извините это место уже забронировали, пожалуйста выберите другое</h2>
    </div>
<?php
}
?>